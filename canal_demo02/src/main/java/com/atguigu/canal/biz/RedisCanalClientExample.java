...
public class RedisCanalClientExample
{
    ...
    public static void main(String[] args)
    {
        ...
        try {
            ...
            //connector.subscribe("bigdata\\..*");//指定库全表
            //connector.subscribe("bigdata.t_user");//指定库指定表，单表
            //connector.subscribe("bigdata\\..*,test2.t_user,test3.t_user2");//多规则组合使用
            connector.subscribe("bigdata\\..*");
            connector.rollback();
